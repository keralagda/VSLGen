...
// node_modules/@tanstack/router-devtools-core/dist/BaseTanStackRouterDevtoolsPanel-SWyE65Is.js
var tokens = {
  colors: {
    inherit: "inherit",
...
var getServerComponentSlots = (value) => {
  ...
  if (RSC_SLOT_USAGES in v) {
    ...
    if (Array.isArray(usages)) for (const evt of usages) {
      const name = evt == null ? void 0 : evt.slot;
...
var _tmpl$3$1 = template(`<button><span>:</span><span>`);
var _tmpl$4$1 = template(`<div><span>slots</span><div>`);
var _tmpl$5$1 = template(`<span>:`);
var _tmpl$6$1 = template(`<span>`);
var _tmpl$7$1 = template(`<button><span> `);
var _tmpl$8$1 = template(`<div><div><button> [<!> ... <!>]`);
var _tmpl$9$1 = template(`<button><span></span> 🔄 `);
...
function Explorer({ value, defaultExpanded, pageSize = 100, filterSubEntries, ...rest }) {
  ...
  const subEntries = createMemo(() => {
    ...
    } else if (Array.isArray(value())) entries = value().map((d, i2) => makeProperty({
      label: i2.toString(),
      value: d
    }));
    else if (value() !== null && typeof value() === "object" && isIterable(value()) && typeof value()[Symbol.iterator] === "function") entries = Array.from(value(), (val, i2) => makeProperty({
      label: i2.toString(),
      value: val
    }));
    ...
    try {
      if ((_a = match()) == null ? void 0 : _a.params) {
        ...
        if (r.startsWith("$")) {
          ...
          if (p2[trimmed]) return `(${p2[trimmed]})`;
        }
      }
      return "";
    } catch (error) {
  ...
  return (() => {
    ...
    insert(_el$11, (() => {
      ...
      return () => _c$6() ? (() => {
        ...
        insert(_el$65, (() => {
          var _c$9 = memo(() => !!pendingMatches().find((d) => {
            var _a;
...
//# sourceMappingURL=chunk-VVIVG5IE.js.map
